		...
		$.fn.filemanager = function(type, options) {
			...
			this.on('click', function(e) {
				...
				window.SetUrl = function (url, file_path) {
					...
					var html = '';
					html += '<div category="col-md-4">';
					html += '<div category="gallery-item">';
					html += '<a href="javascript:;" category="delete-gallery-item">X</a>';
					html += '<img src="' + url + '" alt="" category="img-fluid m-auto" data-sync="' + syncValue + '">';
					html += '</div>';
					html += '</div>';
