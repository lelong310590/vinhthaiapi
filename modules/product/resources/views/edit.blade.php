...
@section('content')
    ...
    @inject('settingseo', 'Product\Repositories\ProductMetaRepository')
    <div class="component">
                    ...
                    <div class="component-wrapper">
                        <div class="form-group" style="margin-bottom: 0">
                            ...
                            <select name="status" class="form-control">
                                <option value="active" {{ ($data->status == 'active') ? 'selected' : '' }}>Hiển thị
                                </option>
                                <option value="disable" {{ ($data->status == 'disable') ? 'selected' : '' }}>Tạm
                                    khóa</option>
                                <option value="new" {{ ($data->status == 'new') ? 'selected' : '' }}>Sản phẩm
                                    mới</option>
                            </select>
                        </div>
                    </div>
